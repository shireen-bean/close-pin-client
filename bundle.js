...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileEvents = __webpack_require__(9);
	var clothingEvents = __webpack_require__(11);
	var interactEvents = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCurrentProfile = function getCurrentProfile(user_id) {
	  return $.ajax({
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://clothespin.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var api = __webpack_require__(5);
	var profileApi = __webpack_require__(8);

	var setCurrentProfile = function setCurrentProfile(data) {
	  $('#sign-in-modal').modal('hide');
	  console.log(data);
	  var profile_id = data.user.profile.id;
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  api.getCurrentProfile(data.user.id).done(setCurrentProfile).fail(failure);
	};

	var setProfileAfterCreation = function setProfileAfterCreation(data) {
	  var profile_id = data.profile.id;
	  console.log('the profile id is' + profile_id);
	  $('.current-profile').val(profile_id);
	  $('#sign-up-button').hide();
	  $('#sign-in-button').hide();
	...
	var signInSuccessAfterSignUp = function signInSuccessAfterSignUp(data) {
	  app.user = data.user;
	  console.log(app.user);
	  ...
	  profileApi.createProfile(user_id).done(setProfileAfterCreation).fail(failure);
	};

	var signInRequest = function signInRequest(email, pass) {
	  return $.ajax({
	    url: app.host + '/sign-in',
	    method: "POST",
	...
	var signUpSuccess = function signUpSuccess(data) {
	  ...
	  signInRequest(email, pass).done(signInSuccessAfterSignUp).fail(failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createProfile = function createProfile(user_id) {
	  return $.ajax({
	...
	var updateProfile = function updateProfile(data, profile_id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateProfile = function onCreateProfile(event) {
	  ...
	  var data = getFormFields(event.target);
	  profileApi.createProfile(data).done(profileUi.createProfileSuccess).fail(profileUi.failure);
	};
	...
	var onUpdateProfile = function onUpdateProfile(event) {
	  ...
	  var data = getFormFields(event.target);
	  profileApi.updateProfile(data, profile_id).done(profileUi.updateProfileSuccess).fail(profileUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clothingApi = __webpack_require__(12);
	var clothingUi = __webpack_require__(13);

	var onCreateShirt = function onCreateShirt(event) {
	  event.preventDefault();
	  console.log(event.target);
	  var data = getFormFields(event.target);
	  clothingApi.createShirt(data).done(clothingUi.createShirtSuccess).fail(clothingUi.failure);
	};

	var onCreateBottom = function onCreateBottom(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  clothingApi.createBottom(data).done(clothingUi.createBottomSuccess).fail(clothingUi.failure);
	};

	var onCreateAccessory = function onCreateAccessory(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  clothingApi.createAccessory(data).done(clothingUi.createAccessorySuccess).fail(clothingUi.failure);
	};

	var onCreateShoes = function onCreateShoes(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  clothingApi.createShoes(data).done(clothingUi.createShoesSuccess).fail(clothingUi.failure);
	};

	var onDisplayTops = function onDisplayTops(event) {
	  event.preventDefault();
	  var profile_id = $('.current-profile').val();
	  clothingApi.getAll(profile_id).done(clothingUi.showAllTopsSuccess).fail(clothingUi.failure);
	};

	var onDisplayBottoms = function onDisplayBottoms(event) {
	  event.preventDefault();
	  var profile_id = $('.current-profile').val();
	  clothingApi.getAll(profile_id).done(clothingUi.showAllBottomsSuccess).fail(clothingUi.failure);
	};

	var onDisplayAccessories = function onDisplayAccessories(event) {
	  event.preventDefault();
	  var profile_id = $('.current-profile').val();
	  clothingApi.getAll(profile_id).done(clothingUi.showAllAccessoriesSuccess).fail(clothingUi.failure);
	};

	var onDisplayShoes = function onDisplayShoes(event) {
	  event.preventDefault();
	  var profile_id = $('.current-profile').val();
	  clothingApi.getAll(profile_id).done(clothingUi.showAllShoesSuccess).fail(clothingUi.failure);
	};

	var onCreateOutfit = function onCreateOutfit(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  clothingApi.newOutfit(data).done(clothingUi.newOutfitSuccess).fail(clothingUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createShirt = function createShirt(data) {
	  return $.ajax({
	    url: app.host + '/shirts',
	    method: "POST",
	    headers: {
	...
	var createBottom = function createBottom(data) {
	  return $.ajax({
	...
	var createAccessory = function createAccessory(data) {
	  return $.ajax({
	...
	var createShoes = function createShoes(data) {
	  return $.ajax({
	    url: app.host + '/shoes',
	    method: "POST",
	    headers: {
	...
	var getAll = function getAll(profile_id) {
	  return $.ajax({
	    url: app.host + '/profiles/' + profile_id,
	    method: "GET",
	    headers: {
	...
	var newOutfit = function newOutfit(data) {
	  return $.ajax({
	...
	var deleteTop = function deleteTop(shirt_id) {
	  return $.ajax({
	...
	var deleteBottom = function deleteBottom(bottom_id) {
	  return $.ajax({
	...
	var deleteAccessory = function deleteAccessory(accessory_id) {
	  return $.ajax({
	...
	var deleteShoe = function deleteShoe(shoe_id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSelectBottom = function onSelectBottom(event) {
	  event.preventDefault();
	  var id = $(this).val();
	  console.log(id);
	  var image_url = $(this).find('img').attr('src');
	...
	var onSelectAccessory = function onSelectAccessory(event) {
	  event.preventDefault();
	  var id = $(this).val();
	  console.log(id);
	  var image_url = $(this).find('img').attr('src');
	...
	var onSelectShoes = function onSelectShoes(event) {
	  event.preventDefault();
	  var id = $(this).val();
	  console.log(id);
	  var image_url = $(this).find('img').attr('src');
	...
	var onDeleteTop = function onDeleteTop(event) {
	  event.preventDefault();
	  var item = $(this);
	  var id = $(this).val();
	  console.log('will delete this shirt id' + id);
	  clothingApi.deleteTop(id).done(function () {
	    item.parent().remove();
	  }).fail(failure);
	};

	var onDeleteBottom = function onDeleteBottom(event) {
	  event.preventDefault();
	  var id = $(this).val();
	  var item = $(this);
	  console.log('will delete this bottom id' + id);
	  clothingApi.deleteBottom(id).done(function () {
	    item.parent().remove();
	  }).fail(failure);
	};

	var onDeleteAccessory = function onDeleteAccessory(event) {
	  event.preventDefault();
	  var item = $(this);
	  var id = $(this).val();
	  console.log('will delete this accessory id' + id);
	  clothingApi.deleteAccessory(id).done(function () {
	    item.parent().remove();
	  }).fail(failure);
	};

	var onDeleteShoe = function onDeleteShoe(event) {
	  event.preventDefault();
	  var id = $(this).val();
	  var item = $(this);
	  console.log('will delete this shoe id ' + id);
	  clothingApi.deleteShoe(id).done(function () {
	    item.parent().remove();
	  }).fail(failure);
	};

	var showAllTopsSuccess = function showAllTopsSuccess(data) {
	  $('#show-all').html('');
	  var shirtsArray = data.profile.shirts;
	  ...
	  for (var i = 0; i < shirtsArray.length; i++) {
	    if (shirtsArray[i].image !== null) {
	      ...
	      $("#shirt" + shirtsArray[i].id).append("<button class='delete-item' id='delete-shirt" + shirtsArray[i].id + "' value='" + shirtsArray[i].id + "'>Delete " + shirtsArray[i].top_name + "</button>");
	...
	var showAllBottomsSuccess = function showAllBottomsSuccess(data) {
	  $('#show-all').html('');
	  var bottomsArray = data.profile.bottoms;
	  console.log(bottomsArray);
	  for (var i = 0; i < bottomsArray.length; i++) {
	    if (bottomsArray[i].image !== null) {
	      ...
	      $("#bottom" + bottomsArray[i].id).append("<button class='delete-item' id='delete-bottom" + bottomsArray[i].id + "' value='" + bottomsArray[i].id + "'>Delete " + bottomsArray[i].bottom_name + "</button>");
	      $('#delete-bottom' + bottomsArray[i].id).on('click', onDeleteBottom);
	    }
	  }
	};

	var showAllAccessoriesSuccess = function showAllAccessoriesSuccess(data) {
	  $('#show-all').html('');
	  var accessoriesArray = data.profile.accessories;
	  ...
	  for (var i = 0; i < accessoriesArray.length; i++) {
	    if (accessoriesArray[i].image !== null) {
	      ...
	      $("#accessory" + accessoriesArray[i].id).append("<button class='delete-item' id='delete-accessory" + accessoriesArray[i].id + "' value='" + accessoriesArray[i].id + "'>Delete " + accessoriesArray[i].accessory_name + "</button>");
	      $('#delete-accessory' + accessoriesArray[i].id).on('click', onDeleteAccessory);
	    }
	  }
	};

	var showAllShoesSuccess = function showAllShoesSuccess(data) {
	  $('#show-all').html('');
	  var shoesArray = data.profile.shoes;
	  ...
	  for (var i = 0; i < shoesArray.length; i++) {
	    if (shoesArray[i].image !== null) {
	      ...
	      $("#shoe" + shoesArray[i].id).append("<button class='delete-item' id='delete-shoe" + shoesArray[i].id + "' value='" + shoesArray[i].id + "'>Delete " + shoesArray[i].name + "</button>");
	      $('#delete-shoe' + shoesArray[i].id).on('click', onDeleteShoe);
	    }
	  }
	};

	var newOutfitSuccess = function newOutfitSuccess(data) {
	  console.log(data);
	...
	module.exports = {
	  failure: failure,
	  createShirtSuccess: createShirtSuccess,
	  createBottomSuccess: createBottomSuccess,
	  createAccessorySuccess: createAccessorySuccess,
	  createShoesSuccess: createShoesSuccess,
	  showAllTopsSuccess: showAllTopsSuccess,
	  showAllBottomsSuccess: showAllBottomsSuccess,
	  showAllAccessoriesSuccess: showAllAccessoriesSuccess,
	  showAllShoesSuccess: showAllShoesSuccess,
	  newOutfitSuccess: newOutfitSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var interactApi = __webpack_require__(15);
	var interactUi = __webpack_require__(16);
	...
	var onCreateTopChosen = function onCreateTopChosen(event) {
	  event.preventDefault();
	  $('#add-new-modal').modal('hide');
	  $('#create-top-modal').modal('show');
	};

	var onCreateBottomChosen = function onCreateBottomChosen(event) {
	  event.preventDefault();
	  $('#add-new-modal').modal('hide');
	  $('#create-bottom-modal').modal('show');
	};

	var onCreateAccessoryChosen = function onCreateAccessoryChosen(event) {
	  event.preventDefault();
	...
	var onCreateShoesChosen = function onCreateShoesChosen(event) {
	  event.preventDefault();
	  console.log('create new accessory modal to pop up');
	  $('#add-new-modal').modal('hide');
	...
	var onPins = function onPins(event) {
	  event.preventDefault();
	...
	var onFeed = function onFeed(event) {
	  event.preventDefault();
	  ...
	  $('#display-weather').hide();
	  $('#display-feed').show();
	  interactApi.getAllOutfits().done(interactUi.getAllOutfitsArray).fail(interactUi.failure);
	};

	var onWeek = function onWeek(event) {
	  event.preventDefault();
	  ...
	  interactApi.getTemp("Boston", "MA").done(interactUi.getTempSuccess).fail(interactUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getProfile = function getProfile(profile_id) {
	  return $.ajax({
	    url: app.host + '/profiles/' + profile_id,
	    method: 'GET',
	    headers: {
	...
	var getShirt = function getShirt(shirt_id) {
	  return $.ajax({
	    url: app.host + '/shirts/' + shirt_id,
	    method: 'GET',
	    headers: {
	...
	var getBottom = function getBottom(bottom_id) {
	  return $.ajax({
	    url: app.host + '/bottoms/' + bottom_id,
	    method: 'GET',
	    headers: {
	...
	var getAccessory = function getAccessory(accessory_id) {
	  return $.ajax({
	    url: app.host + '/accessories/' + accessory_id,
	    method: 'GET',
	    headers: {
	...
	var getShoe = function getShoe(shoe_id) {
	  return $.ajax({
	    url: app.host + '/shoes/' + shoe_id,
	    method: 'GET',
	    headers: {
	...
	var deleteOutfit = function deleteOutfit(outfit_id) {
	  return $.ajax({
	...
	var likeOutfit = function likeOutfit(id) {
	  return $.ajax({
	...
	var dislikeOutfit = function dislikeOutfit(id) {
	  return $.ajax({
	    url: app.host + '/outfits/' + id,
	    method: "PATCH",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteOutfitSuccess = function deleteOutfitSuccess() {
	  console.log('outfit deleted');
	};

	var onDeleteOutfit = function onDeleteOutfit(event) {
	  event.preventDefault();
	  var outfit_id = $(this).val();
	  interactApi.deleteOutfit(outfit_id).done(deleteOutfitSuccess).fail(failure);
	};
	...
	var getOutfitArray = function getOutfitArray(data) {
	  ...
	  if (outfitArray.length == 0) {
	    ...
	    var _loop = function _loop(i) {
	      ...
	      var shirt_id = outfitArray[i].shirt_id;
	      console.log(shirt_id);
	      interactApi.getShirt(shirt_id).done(function (data) {
	        var image = data.shirt.image;
	        console.log(image);
	        $("#outfit" + outfitArray[i].id).append("<img src='" + image + "'>");
	      }).fail(failure);
	      var bottom_id = outfitArray[i].bottom_id;
	      console.log(bottom_id);
	      interactApi.getBottom(bottom_id).done(function (data) {
	        var image = data.bottom.image;
	        console.log(image);
	        $("#outfit" + outfitArray[i].id).append("<img src='" + image + "'>");
	      }).fail(failure);
	      var accessory_id = outfitArray[i].accessory_id;
	      console.log(accessory_id);
	      interactApi.getAccessory(accessory_id).done(function (data) {
	        var image = data.accessory.image;
	        console.log(image);
	        $("#outfit" + outfitArray[i].id).append("<img src='" + image + "'>");
	      }).fail(failure);
	      var shoe_id = outfitArray[i].shoe_id;
	      console.log(shoe_id);
	      interactApi.getShoe(shoe_id).done(function (data) {
	        var image = data.shoe.image;
	        console.log(image);
	        $("#outfit" + outfitArray[i].id).append("<img src='" + image + "'>");
	      }).fail(failure);
	...
	var onLikeOutfit = function onLikeOutfit(event) {
	  event.preventDefault();
	  console.log('liked');
	  var item = $(this);
	  var id = $(this).val();
	...
	var onDislikeOutfit = function onDislikeOutfit(event) {
	  event.preventDefault();
	  console.log('disliked');
	  var item = $(this);
	  var id = $(this).val();
	  // item.parent().css('border','5px solid red')
	  interactApi.dislikeOutfit(id).done(function (data) {
	    item.parent().css('opacity', '0.5');item.parent().css('border', '2px solid #D8BFD8');console.log(data);
	  }).fail(failure);
	};

	var getAllOutfitsArray = function getAllOutfitsArray(data) {
	...
	module.exports = {
	  failure: failure,
	  getOutfitArray: getOutfitArray,
	  getTempSuccess: getTempSuccess,
	  getAllOutfitsArray: getAllOutfitsArray
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
